...
```{r Summaries,cache=TRUE,echo=FALSE,warning=FALSE,message=FALSE}
set.seed(2019)
...
```{r DataSamplingCleaning,echo=FALSE,warning=FALSE,message=FALSE}
library(tidytext)
library(dplyr)
library(tm)
library(ggplot2)
...
```{r WordsHistogram,echo=FALSE,warning=FALSE,message=FALSE,fig.align = "center",out.width = '100%',fig.height = 2}
...
```{r WordsCloud,echo=FALSE,warning=FALSE,message=FALSE,fig.align = "center",out.width = '100%',fig.height = 2}
...
```{r Unigrams,echo=FALSE,warning=FALSE,message=FALSE,fig.align = "center",out.width = '100%',out.height = '100%'}

### This will creat Unigram (1-gram) data frame & ggplot per each document (blogs, news and twitter)
...
```{r Bigrams,echo=FALSE,warning=FALSE,message=FALSE,fig.align = "center",out.width = '100%',out.height = '100%'}
### This will creat Bigram (2-gram) data frame & ggplot per each document (blogs, news and twitter)
library(tidyr)
...
### This will creat Unigram (2-gram) data frame & ggplot per each document (blogs, news and twitter)
...
```{r Trigrams,echo=FALSE,warning=FALSE,message=FALSE,fig.align = "center",out.width = '100%',fig.height = 6}
### This will creat Trigram (3-gram) data frame & ggplot per each document (blogs, news and twitter)
...
```{r BigramGgraph,echo=FALSE,warning=FALSE,message=FALSE,fig.align = "center",out.width = '100%',out.height = '100%'}
library(igraph)
library(ggraph)
...
```{r TrigramGgraph,echo=FALSE,warning=FALSE,message=FALSE,fig.align = "center",out.width = '100%',out.height = '100%'}
###Trigram network
library(tidyr)
set.seed(2019)
...
```{r Appendix-1_DownloadData,eval=FALSE}
### Setting seed
set.seed(2019)
...
```{r Appendix-2_GettingSummariseCleaning,eval=FALSE}
...
```{r Appendix-3_ExloratoryPlotsVisualization,eval=FALSE}
### Histogram of words frequency
total_words <- alldocument_DT %>% 
  group_by(document) %>% 
  summarize(total = sum(n))
